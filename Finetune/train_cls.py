...
if __name__ == '__main__':
    ...
    # Here is where we add the CheXzero model
    ...
    if config['cls']['pretrained']:
        ...
        try: 
            ...
            weights = checkpoint
        common_keys = set(weights.keys()).intersection(set(model_state_dict.keys()))
    ...
    callbacks = [
        ...
        EarlyStopping(monitor="train_loss", min_delta=0.,
