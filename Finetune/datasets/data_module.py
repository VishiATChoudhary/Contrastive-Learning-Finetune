...
class DataModule(pl.LightningDataModule):
    def __init__(self, dataset, config, collate_fn, transforms, data_pct, batch_size, num_workers, crop_size=224):
        super().__init__()
    ...
    # def __str__(self):
    #     return f"DataModule for {self.dataset.__name__} with batch size {self.batch_size}"
